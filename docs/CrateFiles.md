...
| Neighbor crate index (positive Y) | `s16`       | The index of a neighboring crate in this group (or -1 if there is none).                                                                                         |
| Neighbor crate index (negative Y) | `s16`       | The index of a neighboring crate in this group (or -1 if there is none).                                                                                         |
| Neighbor crate index (positive Z) | `s16`       | The index of a neighboring crate in this group (or -1 if there is none).                                                                                         |
| Neighbor crate index (negative Z) | `s16`       | The index of a neighboring crate in this group (or -1 if there is none).                                                                                         |
| Neighbor crate index (positive X) | `s16`       | The index of a neighboring crate in this group (or -1 if there is none).                                                                                         |
| Neighbor crate index (negative X) | `s16`       | The index of a neighboring crate in this group (or -1 if there is none).                                                                                         |
| Exclamation crate index           | `s16`       | For empty crates: The index of the exclamation crate that will change the empty crate into crate type C.                                                         |
